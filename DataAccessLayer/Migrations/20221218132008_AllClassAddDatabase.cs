...
{
    public partial class AllClassAddDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    confirmed = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MemberMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShopStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Category2Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Category2Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CatalogId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Category2s_Catalogs_CatalogId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Category2s_Category2Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarEngineBox = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CarBody = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CarMileagekm = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ProductOwnerName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductNew = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Year = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Color = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NumberOfRooms = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Fieldm2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PlaceOfResidence = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RentForSale = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    LandForSale = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_Category2Id",
                table: "Categories",
                column: "Category2Id");

            migrationBuilder.CreateIndex(
                name: "IX_Category2s_CatalogId",
                table: "Category2s",
                column: "CatalogId");
